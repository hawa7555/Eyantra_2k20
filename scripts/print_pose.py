...
class Ur5Moveit:
    ...
    def print_joint_angles(self):
        ...
        rospy.loginfo('\033[94m' + "\nJoint Values: \n\n" +
                      "ur5_shoulder_pan_joint: {}\n".format((list_joint_values[0])) +
                      "ur5_shoulder_lift_joint: {}\n".format((list_joint_values[1])) +
                      "ur5_elbow_joint: {}\n".format((list_joint_values[2])) +
                      "ur5_wrist_1_joint: {}\n".format((list_joint_values[3])) +
                      "ur5_wrist_2_joint: {}\n".format((list_joint_values[4])) +
                      "ur5_wrist_3_joint: {}\n".format((list_joint_values[5])) +
                      '\033[0m')
